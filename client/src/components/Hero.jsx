...
const Hero = () => {
    ...
    const { navigate, getToken, axios, serSearchedCities } = useAppContext();
    ...
    return (
        <div className='flex flex-col items-start justify-center px-6 md:px-16 lg:px-24 xl:px-32 text-white bg-[url("/src/assets/heroImage.jpg")] bg-no-repeat bg-cover bg-center h-screen'>
            ...
            <p className='mx-w-130 mt-2 text-sm md:text-base'>Unparralleld luxury and comfort await at the world's most exclusive hotels and resorts. Start your journey today.</p>
